...
const SPEED_MIN_EXP = -2;   // 2^-2 = 0.25\u00d7
const SPEED_MAX_EXP = 4;    // 2^4  = 16\u00d7
...
/* 'input' fires continuously while dragging the slider; 'change'
   only fires on release. 'input' is the standard choice for live
   feedback on range inputs. */
replaySpeed.addEventListener('input', () => {
  replaySpeedReadout.textContent = formatSpeed(currentSpeed());
  if (replayState.playing) {
    // Re-base playback timing so the speed change doesn't cause a jump
